...
<head>
    ...
    <link href="{{ asset('assets/css/fallback.css') }}" rel="stylesheet" type="text/css" />
    ...
    <div class="container">
        <div class="left-section">
            <div class="inner-content">
                ...
                <p class="subheading">Looks like the page you were looking for is no longer here.
                    <br>
                </p>
                <div class="btn">
                    <a href="{{ route('dashboard') }}" class="back-btn">Back To Home</a>
                </div>
            </div>
        </div>
        <div class="right-section">
            <svg class="svgimg" xmlns="http://www.w3.org/2000/svg" viewBox="51.5 -15.288 385 505.565">
              ...
              S149.306,67.362,149.306,71.528z" />
                    ...
                    <circle class="lamp-light__glow" fill="url(#SVGID_1_)" cx="119.676" cy="44.22"
                        r="65" />
                    <path class="lamp-bottom"
