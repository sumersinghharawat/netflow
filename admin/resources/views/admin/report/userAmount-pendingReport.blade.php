                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        @forelse($amountPaids as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    {{ $currency . '' . formatCurrency($data->balance_amount) }}
                                                </td>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td>
                                                {{ $currency . '' . formatCurrency($amountPaids->sum('balance_amount')) }}
                                            </td>
                                            <td>
    ...
    <script>
        ...
        const downloadExcel = () => {
            try {
                ...
                var url = "{{ route('export.excel.ManualPayoutPending') }}?" + $.param(data)
        ...
        const downloadCSV = () => {
            try {
                ...
                var url = "{{ route('export.ManualPayoutPending.csv') }}?" + $.param(data)
                var a = document.createElement("a");
                a.href = url;
