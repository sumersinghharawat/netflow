<div class="table-responsive">
    <table class="table align-middle table-nowrap table-check" id="epinTable">
        <thead class="table-light">
            <tr>
                ...
                <th class="align-middle">{{ __('balanceAmount') }}</th>
        ...
        <span id="epinTableBody">

        </span>
        <tbody>

            @forelse ($activePinNumbers as $epin)
